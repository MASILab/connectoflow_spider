...
# Date from Slant must be slightly modified for Connectoflow
...
python3.7 /CODE/get_labels_list.py raw/${N_SUBJ}_${N_SESS}/labels.nii.gz labels_list.txt
...
# Generate PDF
python3.7 /CODE/generate_connectoflow_spider_pdf.py ${N_SUBJ}_${N_SESS} 
